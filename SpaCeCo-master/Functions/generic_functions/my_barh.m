function handleToThisBarSeries=my_barh(array,names,cmap,ax_)

% Vertical Bar scatter plot with each column a different color
...
for b = 1 : numberOfBars
	...
	handleToThisBarSeries(b) = barh(ax_,x(b), y(b), 'BarWidth', 0.9);
